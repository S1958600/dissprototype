...
class SyllogismController:
    ...
    def process_venn_input(raw_syllogism, input_premises_manager, input_conclusion_manager):
        ...
        input_premises_manager.add_statement(evaluation['premises'].get_statements())
        input_conclusion_manager.add_statement(evaluation['conclusion'].get_statements())
        ...
        #TODO return managers conflicts marked, if any